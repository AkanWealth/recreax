            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-1/2 p-8 bg-[#0D192B] order-1 lg:order-2">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className={`text-xl lg:text-2xl font-bold text-white ${bricolage.className}`}>
              ...
              <div className="flex flex-col lg:flex-row">
                <div className="lg:w-1/2 p-8 text-[#12233D] order-1">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className={`text-xl lg:text-2xl font-bold ${bricolage.className}`}>
                      ReCreaX Studio Cohort
                    </h3>
                  </div>
                  <p className={`text-[#2A2829] text-sm lg:text-lg mb-6 leading-relaxed ${plusJakarta.className}`}>
                  ...
                  <ul className={`space-y-3 mb-10 ${plusJakarta.className}`}>
